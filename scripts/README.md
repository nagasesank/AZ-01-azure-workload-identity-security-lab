...
A separate OIDC validation harness is planned in the [Phase 5 test plan](../docs/attack-path/phase-5-validation-plan.md). Implementation and runtime execution are pending. The Phase 3 harness remains unchanged as historical code.
